...
root.innerHTML = `
  ...
  <section class="action-section">
    <div class="action-buttons">
      <button class="action-btn intro-btn" onclick="showIntroduction()">
        Introductions
      </button>
      <button class="action-btn showcase-btn" onclick="showShowcase()">
        Showcase
      </button>
    </div>
  </section>
  ...
  <footer class="footer">
    <div class="footer-content">
      <div class="footer-section">
        <h4>Uni-MoE</h4>
        <p>Unified Mixture of Experts for Enhanced AI Performance</p>
      </div>
      <div class="footer-section">
        <div class="footer-links">
            <div class="footer-icons">
              ...
              <a href="https://huggingface.co/Uni-MoE" target="_blank" class="footer-link" title="Hugging Face">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-3.5-6.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5zm5 0c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5z"/>
                </svg>
              </a>
            </div>
            <div class="footer-copyright">
              <p>&copy; 2025 Uni-MoE</p>
            </div>
          </div>
      </div>
    </div>
