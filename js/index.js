  ...
  <footer class="footer">
    <div class="footer-content">
      ...
      <div class="footer-section">
        <h4>Links</h4>
        <ul>
          <li><a href="#" onclick="showIntroduction()">Introduction</a></li>
          <li><a href="#" onclick="showShowcase()">Showcase</a></li>
      ...
      <div class="footer-section">
        ...
        <ul>
          ...
          <li><a href="mailto:contact@unimoe.com">Contact</a></li>
          <li><a href="#" onclick="showIntroduction()">Documentation</a></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <p>&copy; 2025 Uni-MoE Project. All rights reserved.</p>
    </div>
  </footer>
`;
